 ...
 */
val resolvedVersionCode = System.getenv("BASTION_VERSION_CODE")?.toIntOrNull()?.let { it + 1000 } ?: 4
val resolvedVersionName = System.getenv("BASTION_VERSION_NAME")?.takeIf { it.isNotBlank() } ?: "0.4.0"
