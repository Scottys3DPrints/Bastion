 ...
 */
val resolvedVersionCode = System.getenv("BASTION_VERSION_CODE")?.toIntOrNull()?.let { it + 1000 } ?: 16
val resolvedVersionName = System.getenv("BASTION_VERSION_NAME")?.takeIf { it.isNotBlank() } ?: "0.16.0"
