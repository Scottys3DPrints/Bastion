 ...
 */
val resolvedVersionCode = System.getenv("BASTION_VERSION_CODE")?.toIntOrNull()?.let { it + 1000 } ?: 9
val resolvedVersionName = System.getenv("BASTION_VERSION_NAME")?.takeIf { it.isNotBlank() } ?: "0.9.0"
